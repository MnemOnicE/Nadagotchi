...
-   **[ ] Future Work:**
    ...
    -   [x] **Career Progression:** Implemented Career Levels (1-5) and XP system with title changes and bonuses.
    -   [x] **Career Flexibility:** Implemented Career UI to allow players to switch between unlocked careers.
...
-   **[ ] Future Work:**
    ...
    -   [x] **Dynamic Daily Quests:** Implemented procedural daily quests based on Season and Weather (e.g., "Forage Firewood in Winter", "Hot Cocoa in Rain").
...
The Nadagotchi project is an evolving digital life simulation. This roadmap outlines the high-level goals and planned features for future updates.
...
- [x] **Performance**: Optimize main loop object allocation (Completed).
...
- **Career Promotion**: Levels within careers (Apprentice -> Master).
- **Workplace Events**: Random scenarios during work minigames.
...
- **Sound Design**: Dynamic soundtrack that changes with mood and season.
- **Mobile App**: PWA wrapper for native mobile experience.
