...
export class MainScene extends Phaser.Scene {
    ...
    async initializeGame(data) {
        ...
        if (this.nadagotchi && typeof this.nadagotchi.init === "function") if (typeof this.nadagotchi.init === "function") { await this.nadagotchi.init(); }
    ...
    startIdleAnimation(mood) {
        ...
        const baseX = this.location === 'INDOOR' ? this.sprite.x : this.scale.width / 2;
