...
Aesthetic Integration:
Job Centers/Guilds: Pixel-art "Guild Halls," "Research Institutes," "Artisan Workshops," or "Explorer's Outposts" on the world map, visually hinting at career specializations (e.g., a building with a large telescope for an Astronomer path, a forge for a Crafter path). These locations should have distinct Emerald/Sapphire style architecture.
